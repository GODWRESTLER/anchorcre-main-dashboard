          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg space-y-8">
            <section>
              ...
              <div className="space-y-4 text-slate-700">
                <p>
                  We collect information you provide directly to us, such as when you fill out our loan qualification forms, 
            ...
            <section>
              ...
              <div className="space-y-4 text-slate-700">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>Provide loan consultation and support services</li>
                  <li>Communicate with you about your loan inquiry</li>
            ...
            <section>
              ...
              <div className="space-y-4 text-slate-700">
                <p>
                  We may share your information with qualified lenders in our network to facilitate 
                  your financing request. We do not sell your personal information to third parties.
                </p>
                <p className="font-semibold bg-blue-50 p-4 rounded-lg border border-blue-200">
                  <strong>Important:</strong> No mobile information will be shared with third parties/affiliates 
                  for marketing/promotional purposes. All the above categories exclude text messaging originator 
