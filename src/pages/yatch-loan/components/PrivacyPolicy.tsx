          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg space-y-8">
            ...
            <section>
              ...
              <div className="space-y-4 text-slate-700">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>Match you with qualified bridge lenders in our network</li>
                  <li>Provide bridge loan consultation and support services</li>
                  <li>Communicate with you about your bridge loan inquiry</li>
            ...
            <section>
              ...
              <div className="space-y-4 text-slate-700">
                ...
                <div className="bg-slate-50 rounded-lg p-4">
                  <p><strong>Email:</strong> privacy@anchorcreloans.com</p>
