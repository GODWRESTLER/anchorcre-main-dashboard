        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 mb-6 leading-relaxed">
              ...
              from our specialized network. We connect real estate investors and house flippers 
              from our specialized network. We connect real estate developers and builders 
              with the right financing in 24-48 hours.
            </p>
            
            <div className="space-y-3 mb-6">
              <div className="flex items-center space-x-3 text-slate-400">
                <Phone size={16} />
                <span className="swap-655309314-1b51cd7ce69298ffdfa6">(555) 123-FLIP</span>
              </div>
              <div className="flex items-center space-x-3 text-slate-400">
                <Mail size={16} />
