      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
            Get Construction Loan Quote in{' '}
            <span className="text-blue-500">2 Minutes</span>
          </h2>
          <p className="text-xl text-slate-600 mb-8">
            AI-powered matching with specialized construction lenders. Fast approvals for ground up development projects.
          </p>
          ...
          <div className="flex items-center justify-center space-x-4 mb-8">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-slate-600">Construction Specialists</span>
            </div>
          </div>
        </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {['Ground-Up Construction', 'Construction-to-Permanent', 'Spec Home Construction', 'Custom Home Construction'].map((type) => (
                      <button
                        key={type}
                        type="button"
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {['Single Family', 'Duplex/Triplex', 'Multifamily', 'Townhomes', 'Mixed-Use', 'Commercial'].map((type) => (
                      <button
                        key={type}
                        type="button"
              ...
              >
                ...
                <div className="bg-blue-50 rounded-xl p-4 text-xs sm:text-sm text-slate-600">
                  <p className="mb-2">
                    ...
                    regarding your construction loan inquiry. 
                  </p>
                  <p>
