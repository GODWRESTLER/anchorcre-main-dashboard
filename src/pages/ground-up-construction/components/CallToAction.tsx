...
const CallToAction = () => {
  const [formData, setFormData] = React.useState({
    ...
    lastName: '',
    email: '',
    ApplyingFor: 'Ground Up Construction Loan',
    phone: '',
    loanAmount: '',
    smsOptIn: false
  });
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            ...
            <span className="text-blue-300">Construction Project</span>?
          </h2>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Submit your construction project and get matched with qualified construction lenders 
          ...
          >
            <div className="space-y-6">
              {[
                {
                  icon: Clock,
                  title: 'Easy 7 Draw Process',
                  description: 'Streamlined 7 draw process with 18-month terms - no complex inspections'
                },
                {
                  icon: CheckCircle,
                  title: 'Up to 90% LTC & 75% LTV',
                  description: 'Maximum financing for single family up to 50 units and multi-family'
                },
                {
                  icon: Phone,
                  title: 'Rates from 9.00%',
                  description: 'Competitive rates starting at 9.00% for qualified construction projects'
                }
              ].map((benefit, index) => (
                <motion.div
                  key={index}
            ...
            >
              ...
              <p className="text-blue-100 italic">
                "Got $15M financing at 9.50% with 90% LTC for our 25-unit development. 
                The 7 draw process made construction management so much easier."
              </p>
              <div className="text-blue-300 text-sm mt-2">
                - Jennifer Walsh, Custom Home Builder
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-slate-600">
                Get matched with qualified construction lenders in 24-48 hours
              </p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-start space-x-3 p-4 bg-slate-50 rounded-xl">
                ...
                <label htmlFor="smsOptInCTA" className="text-slate-700 text-sm leading-relaxed cursor-pointer">
                  ...
                  regarding my construction loan inquiry. Message and data rates may apply. Reply STOP to opt out.
                </label>
              </div>
              ...
              <div className="text-xs text-slate-500 text-center">
                <p className="mb-2">
                  ...
                  you consent to receive calls and emails from Anchor Commercial Capital regarding your construction loan inquiry. 
                </p>
                <p>
        ...
        >
          <div className="inline-flex items-center space-x-8 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full px-8 py-4">
            <div className="text-center">
              ...
              <div className="text-blue-200 text-sm">Rates From</div>
            </div>
            <div className="w-px h-8 bg-white/20"></div>
            <div className="text-center">
              <div className="text-2xl font-bold text-white">90% LTC</div>
            ...
            <div className="w-px h-8 bg-white/20"></div>
            <div className="text-center">
              <div className="text-2xl font-bold text-white">7 Draws</div>
              <div className="text-blue-200 text-sm">Easy Process</div>
            </div>
          </div>
        </motion.div>
      </div>
