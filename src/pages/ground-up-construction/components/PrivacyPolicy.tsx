          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg space-y-8">
            <section>
              ...
              <div className="space-y-4 text-slate-700">
                <p>
                  We collect information you provide directly to us, such as when you fill out our construction loan qualification form, 
            ...
            <section>
              ...
              <div className="space-y-4 text-slate-700">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>Match you with qualified construction lenders in our network</li>
                  <li>Provide construction loan consultation and support services</li>
                  <li>Communicate with you about your construction loan inquiry</li>
            ...
            <section>
              ...
              <div className="space-y-4 text-slate-700">
                <p>
                  We may share your information with qualified construction lenders in our network to facilitate 
