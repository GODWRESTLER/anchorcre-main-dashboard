          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg space-y-8">
            <section>
              ...
              <div className="space-y-4 text-slate-700">
                <p>
                  ...
                  your construction loan inquiry and related services.
                </p>
                <p>
            ...
            <section>
              ...
              <div className="space-y-4 text-slate-700">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>Your construction loan application status</li>
                  <li>Lender matching and introductions</li>
                  <li>Market updates and financing opportunities</li>
                  <li>Educational content about bridge loans</li>
                  <li>Educational content about construction loans</li>
