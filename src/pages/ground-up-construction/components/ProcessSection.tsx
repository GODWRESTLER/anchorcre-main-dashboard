...
const processSteps = [
  {
    ...
    description: 'Complete our 2-minute AI-powered construction project requirements form',
    timeline: '2 minutes',
    color: 'bg-blue-500'
  },
  {
    ...
    description: 'Our system matches you with qualified lenders for your specific construction project needs',
  ...
  },
  {
    ...
    description: 'Connect directly with matched lenders to discuss terms, draws, and project timeline',
    timeline: '2-5 days',
    color: 'bg-purple-500'
  },
  {
    ...
    description: 'Move from term sheet to closing and construction draws with ongoing support',
    timeline: '2-4 weeks',
    color: 'bg-orange-500'
  }
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            ...
            ground up construction loan timeline.
          </p>
        </motion.div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-3xl p-8 max-w-4xl mx-auto">
            <div className="bg-orange-100 border border-orange-300 rounded-lg p-4 mb-6">
              <p className="text-orange-700 font-semibold text-center">
                🔥 Act Fast: Rising rates mean higher borrowing costs - Submit your construction project today
              </p>
            </div>
            <h3 className="text-2xl font-bold text-slate-900 mb-4">
              Speed vs. Traditional Construction Lending
            </h3>
            <p className="text-slate-600 mb-6">
              While traditional construction lenders take 45-90+ days with complex underwriting and lengthy draw processes, 
              Anchor Commercial Capital connects you with lenders who can close in 2 weeks with our easy 7 draw process.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              ...
              <div>
                <div className="text-3xl font-bold text-green-500 mb-2">7 Draws</div>
                <div className="text-slate-600">Easy Process</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-purple-500 mb-2">18 Months</div>
