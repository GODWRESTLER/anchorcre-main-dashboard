              ...
              >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {['Fix & Flip Construction', 'Purchase + Renovation', 'Refinance + Renovation', 'Ground-Up Construction'].map((type) => (
                      <button
                        key={type}
                        type="button"
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {['Single Family', 'Duplex/Triplex', 'Small Multifamily', 'Condo/Townhome', 'Mixed-Use', 'Commercial'].map((type) => (
                      <button
                        key={type}
                        type="button"
