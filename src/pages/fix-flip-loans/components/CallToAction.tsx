      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            ...
            <span className="text-blue-300">Fix & Flip Project</span>?
          </h2>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Submit your fix & flip project and get matched with qualified construction lenders 
          ...
          >
            <div className="space-y-6">
              {[
                {
                  icon: Clock,
                  title: 'Fast 2 Week Closings',
                  description: 'Skip the slow bank process - our lenders close fix & flip loans quickly'
                },
                {
                  icon: CheckCircle,
                  title: 'Streamlined Draw Process',
                  description: 'No complex draw inspections or lengthy approval processes'
                },
                {
                  icon: Phone,
                  title: 'Investor-Friendly Lenders',
                  description: 'Access lenders who understand fix & flip projects and say yes to investors'
                }
              ].map((benefit, index) => (
                <motion.div
                  key={index}
            ...
            >
              ...
              <p className="text-blue-100 italic">
                ...
                The automated matching saved me weeks of research and got me 90% LTV."
              </p>
              <div className="text-blue-300 text-sm mt-2">
                - Mike Thompson, Real Estate Investor
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-slate-900 mb-2">
                Submit Your Fix & Flip Project
              </h3>
              <p className="text-slate-600">
                Get matched with qualified fix & flip lenders in 24-48 hours
              </p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-start space-x-3 p-4 bg-slate-50 rounded-xl">
                ...
                <label htmlFor="smsOptInCTA" className="text-slate-700 text-sm leading-relaxed cursor-pointer">
                  ...
                  regarding my fix & flip loan inquiry. Message and data rates may apply. Reply STOP to opt out.
                </label>
              </div>
              ...
              <div className="text-xs text-slate-500 text-center">
                <p className="mb-2">
                  ...
                  you consent to receive calls and emails from Anchor Commercial Capital regarding your fix & flip loan inquiry. 
                </p>
                <p>
