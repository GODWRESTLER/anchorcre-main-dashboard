        ...
        <div className="text-center">
          ...
          >
            <span className="inline-block bg-blue-500/20 text-blue-300 px-4 py-2 rounded-full text-sm font-medium border border-blue-400/30">
              Fix & Flip Construction Loan Specialist
            </span>
          </motion.div>
          ...
          >
            Fast construction financing for fix & flip real estate investors. 
            Get matched with specialized lenders who fund renovation projects quickly with flexible terms.
          </motion.p>
          ...
          >
            ...
            >
              <span>Get Fix & Flip Loan Quote</span>
              <ArrowRight size={20} />
            </motion.button>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              ...
              <div>
                <div className="text-3xl font-bold text-white mb-2">90% LTV</div>
                <div className="text-blue-200">Max Financing</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white mb-2">12 Months</div>
                <div className="text-blue-200">Loan Terms</div>
              </div>
            </div>
            <div className="text-center mt-6 text-slate-300">
              Trusted by real estate investors and house flippers nationwide
            </div>
          </motion.div>
        </div>
      </div>
