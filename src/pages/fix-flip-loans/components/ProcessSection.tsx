...
const processSteps = [
  {
    ...
    description: 'Complete our 2-minute AI-powered fix & flip project requirements form',
    timeline: '2 minutes',
    color: 'bg-blue-500'
  },
  {
    ...
    description: 'Our system matches you with qualified lenders for your specific fix & flip project needs',
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            ...
            fix & flip construction loan timeline.
          </p>
        </motion.div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-3xl p-8 max-w-4xl mx-auto">
            <div className="bg-orange-100 border border-orange-300 rounded-lg p-4 mb-6">
              <p className="text-orange-700 font-semibold text-center">
                🔥 Act Fast: Rising rates mean higher borrowing costs - Submit your fix & flip project today
              </p>
            </div>
            ...
            <p className="text-slate-600 mb-6">
              ...
              Anchor Commercial Capital connects you with lenders who can close in 2 weeks with streamlined processes.
            </p>
