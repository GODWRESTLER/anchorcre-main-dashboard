      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
            Get Bridge Loan Quote in{' '}
            <span className="text-blue-500">2 Minutes</span>
          </h2>
          <p className="text-xl text-slate-600 mb-8">
            AI-powered matching with specialized bridge lenders. Fast approvals for time-sensitive commercial deals.
          </p>
          ...
          <div className="flex items-center justify-center space-x-4 mb-8">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-slate-600">Bridge Loan Specialists</span>
            </div>
          </div>
        </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {['Acquisition Bridge', 'Refinance Bridge', 'Construction Bridge', 'Fix & Flip Bridge'].map((type) => (
                      <button
                        key={type}
                        type="button"
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {['Office', 'Retail', 'Industrial', 'Multifamily', 'Mixed-Use', 'Land/Development'].map((type) => (
                      <button
                        key={type}
                        type="button"
            ...
            {currentStep === 2 && (
              ...
              >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {['ASAP (< 2 weeks)', '2-4 weeks', '1-2 months', 'Planning stage (2+ months)'].map((timeline) => (
                      <button
                        key={timeline}
                        type="button"
            ...
            {currentStep === 3 && (
              ...
              >
                ...
                <div className="bg-blue-50 rounded-xl p-4 text-xs sm:text-sm text-slate-600">
                  <p className="mb-2">
                    <strong>TCPA Compliance Notice:</strong> By providing your contact information and clicking "Get Matched with Lenders," 
