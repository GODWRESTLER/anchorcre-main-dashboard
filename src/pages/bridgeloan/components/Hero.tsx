        ...
        <div className="text-center">
          ...
          >
            <span className="inline-block bg-blue-500/20 text-blue-300 px-4 py-2 rounded-full text-sm font-medium border border-blue-400/30">
              Commercial Real Estate Financing Specialist
            </span>
          </motion.div>
          ...
          >
            Bridge Loans That{' '}
            <span className="text-blue-400">Close in 2-3 Weeks</span>
          </motion.h1>
          ...
          >
            Fast bridge financing for time-sensitive commercial real estate deals. 
            Get matched with specialized bridge lenders who close in 2-3 weeks, not months.
          </motion.p>
          ...
          >
            ...
            >
              <span>Get Bridge Loan Quote</span>
              <ArrowRight size={20} />
            </motion.button>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              ...
              <div>
                ...
                <div className="text-blue-200">Active Lenders</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white mb-2">24-48hr</div>
                <div className="text-blue-200">Initial Response</div>
              </div>
            </div>
            <div className="text-center mt-6 text-slate-300">
              Trusted by property owners, investors, and developers nationwide
            </div>
          </motion.div>
        </div>
      </div>
