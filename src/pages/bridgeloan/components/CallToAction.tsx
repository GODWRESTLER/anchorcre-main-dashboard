      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            ...
            <span className="text-blue-300">CRE Deal</span>?
          </h2>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Submit your commercial real estate deal and get matched with qualified lenders 
            in 24-48 hours through Anchor Commercial Capital's exclusive network.
          </p>
        </motion.div>
          ...
          >
            <div className="space-y-6">
              {[
                {
                  icon: Clock,
                  title: 'Fast 2-3 Week Closings',
                  description: 'Skip the slow bank process - our lenders close deals quickly'
                },
                {
                  icon: CheckCircle,
                  title: 'Streamlined Approval',
                  description: 'No endless paperwork or difficult underwriting processes'
                },
                {
                  icon: Phone,
                  title: 'Flexible Lenders',
                  description: 'Access lenders who say yes when banks say no'
                }
              ].map((benefit, index) => (
                <motion.div
                  key={index}
            ...
            >
              ...
              <p className="text-blue-100 italic">
                "Their network included specialty lenders I never would have found on my own. 
                The automated matching saved me weeks of research."
              </p>
              <div className="text-blue-300 text-sm mt-2">
                - Michael Chen, Real Estate Developer
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-slate-600">
                Get matched with qualified lenders in 24-48 hours
              </p>
            </div>
            ...
            <form className="space-y-6">
              ...
              <div className="flex items-start space-x-3 p-4 bg-slate-50 rounded-xl">
                ...
                <label htmlFor="smsOptInCTA" className="text-slate-700 text-sm leading-relaxed cursor-pointer">
                  ...
                  regarding my bridge loan inquiry. Message and data rates may apply. Reply STOP to opt out.
                </label>
              </div>
              ...
              <div className="text-xs text-slate-500 text-center">
                <p className="mb-2">
                  ...
                  you consent to receive calls and emails from Anchor Commercial Capital regarding your bridge loan inquiry. 
                </p>
                <p>
        ...
        >
          <div className="inline-flex items-center space-x-8 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full px-8 py-4">
            ...
            <div className="w-px h-8 bg-white/20"></div>
            <div className="text-center">
              <div className="text-2xl font-bold text-white">24-48hr</div>
              <div className="text-blue-200 text-sm">Initial Response</div>
            </div>
          </div>
        </motion.div>
      </div>
