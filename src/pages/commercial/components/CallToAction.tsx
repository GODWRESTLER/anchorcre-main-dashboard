      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            Get Started with a Trusted{' '}
            <span className="text-blue-300">Private Commercial Lender</span>
          </h2>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            The application process is simple and designed with you in mind. From your first inquiry to final funding, 
            our expert advisors guide you every step of the way with Private Capital Investors.
          </p>
        </motion.div>
          ...
          >
              ...
              {[
                {
                  ...
                  description: 'Streamlined process with dedicated advisors - no more waiting months for bank decisions'
                },
                {
                  icon: CheckCircle,
                  title: 'Flexible Terms',
                  description: 'Fixed-rate terms from 3-10 years with long amortization options up to 30 years'
                },
                {
                  icon: Phone,
                  title: 'Competitive Rates',
                  description: 'Access rates as low as 5.99% with up to 85% LTV from experienced private lenders'
                }
              ].map((benefit, index) => (
                <motion.div
                  key={index}
            ...
            >
              ...
              <p className="text-blue-100 italic">
                "Their private lender network offered rates I couldn't get from banks. 
                The 6.2% rate and 80% LTV on my retail plaza made the deal profitable from day one."
              </p>
              <div className="text-blue-300 text-sm mt-2">
                - David Martinez, Commercial Investor
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-slate-600">
                Get matched with qualified private commercial lenders in 24-48 hours
              </p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-start space-x-3 p-4 bg-slate-50 rounded-xl">
                ...
                <label htmlFor="smsOptInCTA" className="text-slate-700 text-sm leading-relaxed cursor-pointer">
                  ...
                  regarding my commercial real estate loan inquiry. Message and data rates may apply. Reply STOP to opt out.
                </label>
              </div>
              ...
              <div className="text-xs text-slate-500 text-center">
                <p className="mb-2">
                  ...
                  you consent to receive calls and emails from Anchor Commercial Capital 
                  regarding your commercial real estate loan inquiry.
                </p>
                <p>
        ...
        >
          <div className="inline-flex items-center space-x-8 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full px-8 py-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-white">85% LTV</div>
