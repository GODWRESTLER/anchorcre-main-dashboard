      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center">
          ...
          >
            ...
            <span className="text-blue-400">Rates from 5.99%</span>
          </motion.h1>
          ...
          >
            Today's commercial real estate market offers a golden opportunity for smart investors. 
            With CRE loan rates as low as 5.99% and LTV up to 85%, now is the perfect time to act. 
            Flexible funding from trusted private commercial lenders nationwide.
          </motion.p>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              ...
              <div>
                <div className="text-3xl font-bold text-white mb-2">85% LTV</div>
            ...
            <div className="text-center mt-6 text-slate-300">
              Trusted private commercial lenders serving nationwide
            </div>
          </motion.div>
        </div>
      </div>
