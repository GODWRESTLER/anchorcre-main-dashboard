      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
            Get CRE Loan Quote in{' '}
            <span className="text-blue-500">2 Minutes</span>
          </h2>
          <p className="text-xl text-slate-600 mb-8">
            Connect with trusted private commercial lenders. Flexible financing solutions with competitive rates and terms.
          </p>
          ...
          <div className="flex items-center justify-center space-x-4 mb-8">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-slate-600">Private Lender Network</span>
            </div>
          </div>
        </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {['Purchase Financing', 'Refinance', 'Cash-Out Refinance', 'Construction/Development', 'Portfolio Financing'].map((type) => (
                      <button
                        key={type}
                        type="button"
            ...
            {currentStep === 2 && (
              ...
              >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {['Within 30 days', '30-60 days', '60-90 days', 'Planning stage (researching)'].map((timeline) => (
                      <button
                        key={timeline}
                        type="button"
