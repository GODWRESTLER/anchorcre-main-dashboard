        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 mb-6 leading-relaxed">
              Connect with trusted private commercial real estate lenders from our nationwide network. 
              We help commercial real estate investors secure competitive financing with rates as low as 5.99% 
              and flexible terms up to 10 years.
            </p>
        ...
        <div className="border-t border-slate-800 pt-8">
          ...
          <div className="mt-6 text-xs text-slate-500 text-center">
            <p className="mb-2">
              ...
              We connect borrowers with qualified private commercial lenders and earn origination fees upon successful closing.
            </p>
          </div>
        </div>
      </div>
