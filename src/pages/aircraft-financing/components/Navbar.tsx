    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <button onClick={() => scrollToSection('loans')} className="text-slate-300 hover:text-white transition-colors">Aircraft Financing</button>
      ...
      {isOpen && (
        ...
        >
          <div className="flex flex-col space-y-4">
            <button onClick={() => scrollToSection('loans')} className="text-slate-300 hover:text-white transition-colors text-left">Aircraft Financing</button>
