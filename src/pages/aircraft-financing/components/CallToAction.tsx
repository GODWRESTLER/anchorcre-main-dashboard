...
const CallToAction = () => {
  const [formData, setFormData] = React.useState({
    ...
    lastName: '',
    email: '',
    ApplyingFor: 'Aircraft Financing',
    phone: '',
    loanAmount: '',
    aircraftType: '',
    smsOptIn: false
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <h2 className="text-3xl font-bold text-slate-900 mb-4">
              Aircraft Financing Request Submitted!
            </h2>
            <p className="text-xl text-slate-600 mb-8">
              Thank you! We'll analyze your aircraft financing needs and connect you with qualified aviation lenders within 24-48 hours.
            </p>
            <div className="bg-blue-50 rounded-2xl p-6">
              ...
              <div className="space-y-3 text-left">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-slate-700">AI analysis of your aircraft financing requirements (immediate)</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-slate-700">Aviation lender matching and outreach (within 24 hours)</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            ...
            <span className="text-blue-300">Aircraft Financing Request</span>?
          </h2>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Submit your aircraft financing request and get matched with qualified aviation lenders 
          ...
          >
            <div className="space-y-6">
              {[
                {
                  icon: Clock,
                  title: 'Competitive 7.5%-9.0% Rates',
                  description: 'Access competitive interest rates with our specialized aviation lender network'
                },
                {
                  icon: CheckCircle,
                  title: 'No Upfront Fees',
                  description: 'No upfront fees or prepayment penalties - transparent pricing structure'
                },
                {
                  icon: Phone,
                  title: 'Aviation-Friendly Lenders',
                  description: 'Access lenders who understand aircraft values and say yes to aviation financing'
                }
              ].map((benefit, index) => (
                <motion.div
                  key={index}
            ...
            >
              ...
              <p className="text-blue-100 italic">
                "Their network included aviation lenders I never would have found on my own. 
                The automated matching saved me weeks of research and got me 8.1% with no fees."
              </p>
              <div className="text-blue-300 text-sm mt-2">
                - Robert Mitchell, Private Pilot
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-slate-900 mb-2">
                Submit Your Aircraft Financing Request
              </h3>
              <p className="text-slate-600">
                Get matched with qualified aviation lenders in 24-48 hours
              </p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-2">Aircraft Type</label>
                <select 
              ...
              <div className="flex items-start space-x-3 p-4 bg-slate-50 rounded-xl">
                ...
                <label htmlFor="smsOptInCTA" className="text-slate-700 text-sm leading-relaxed cursor-pointer">
                  ...
                  regarding my aircraft financing inquiry. Message and data rates may apply. Reply STOP to opt out.
                </label>
              </div>
              ...
              <div className="text-xs text-slate-500 text-center">
                <p className="mb-2">
                  <strong>TCPA Compliance Notice:</strong> By providing your contact information and clicking "Submit My Request," 
                  you consent to receive calls and emails from Anchor Commercial Capital regarding your aircraft financing inquiry. 
                </p>
                <p>
        ...
        >
          <div className="inline-flex items-center space-x-8 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full px-8 py-4">
            <div className="text-center">
              ...
              <div className="text-blue-200 text-sm">Interest Rates</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-blue-200 text-sm">Min Loan Size</div>
            </div>
          </div>
        </motion.div>
      </div>
