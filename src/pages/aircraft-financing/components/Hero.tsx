    ...
    <section className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 py-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center">
          ...
          >
            Competitive aircraft financing with rates from 7.5%-9.0%. 
            Lease or lending options up to 20 years with no upfront fees or prepayment penalties.
          </motion.p>
          ...
          >
            ...
            >
              <span>Get Aircraft Financing Quote</span>
              <ArrowRight size={20} />
            </motion.button>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <div className="text-blue-200">Interest Rates</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white mb-2">20 Years</div>
                <div className="text-blue-200">Max Term</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white mb-2">$500K</div>
                <div className="text-blue-200">Min Loan Size</div>
              </div>
            </div>
            <div className="text-center mt-6 text-slate-300">
              Trusted by aircraft owners and aviation professionals nationwide
            </div>
          </motion.div>
        </div>
      </div>
