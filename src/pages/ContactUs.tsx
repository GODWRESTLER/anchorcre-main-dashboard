...
import { Phone, Mail, MapPin, Clock, ArrowLeft, ArrowRight, CheckCircle } from 'lucide-react';
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const submissionData = {
      contact: {
        ...
        tags: ['contact-us-lead', 'general-inquiry']
      },
      customFields: {
      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        ...
        >
          ...
          <p className="text-xl text-slate-600 mb-8">
            We've received your message and will contact you within 24 hours to discuss your financing needs.
          </p>
          <Link
            to="/"
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
              Ready to discuss your financing needs? Our experienced lending professionals 
              ...
              <div className="space-y-6">
                {[
                  ...
                  <motion.div
                    ...
                    className="flex items-start space-x-4 bg-white rounded-2xl p-6 shadow-lg"
                  >
                    <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center flex-shrink-0">
                      <contact.icon className="text-blue-500" size={24} />
                    </div>
                    <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-start space-x-3 p-4 bg-slate-50 rounded-xl">
                ...
                <label htmlFor="smsOptInContact" className="text-slate-700 text-sm leading-relaxed cursor-pointer">
                  ...
                  related to your request for information. Message and data rates may apply. Carriers are not liable 
                  for delayed or undelivered messages. Text HELP for help and STOP to unsubscribe. 
              ...
              <div className="text-xs text-slate-500 text-center">
                <p className="mb-2">
                  <strong>TCPA Compliance Notice:</strong> By providing your contact information and clicking "Send Message," 
