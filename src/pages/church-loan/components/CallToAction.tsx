      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            ...
            <span className="text-blue-300">Church Financing Request</span>?
          </h2>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Submit your church financing request and get matched with qualified lenders 
            in 24-48 hours through Anchor Commercial Capital's specialized church network.
          </p>
        </motion.div>
          ...
          >
              ...
              {[
                {
                  ...
                  description: 'Access to major institutions with rates starting at 4.50% for qualified churches'
                },
                {
                  icon: CheckCircle,
                  title: 'Church Expertise',
                  description: 'Lenders who understand tithes, plate income, and religious organization finances'
                },
                {
                  icon: Phone,
                  title: 'Flexible Programs',
                  description: 'Conventional and hard money options for all types of church financing needs'
                }
              ].map((benefit, index) => (
                <motion.div
                  key={index}
            ...
            >
              ...
              <p className="text-blue-100 italic">
                "Their network included church lenders I never would have found on my own. 
                The automated matching saved us weeks of research and got us excellent terms."
              </p>
              <div className="text-blue-300 text-sm mt-2">
                - Pastor Michael Johnson, Grace Community Church
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-slate-600">
                Get matched with qualified church lenders in 24-48 hours
              </p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-start space-x-3 p-4 bg-slate-50 rounded-xl">
                ...
                <label htmlFor="smsOptInCTA" className="text-slate-700 text-sm leading-relaxed cursor-pointer">
                  ...
                  regarding my church loan inquiry. Message and data rates may apply. Reply STOP to opt out.
                </label>
              </div>
              ...
              <div className="text-xs text-slate-500 text-center">
                <p className="mb-2">
                  ...
                  you consent to receive calls and emails from Anchor Commercial Capital regarding your church loan inquiry. 
                </p>
                <p>
        ...
        >
          <div className="inline-flex items-center space-x-8 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full px-8 py-4">
            <div className="text-center">
              ...
              <div className="text-blue-200 text-sm">Minimum Loan</div>
            </div>
            <div className="w-px h-8 bg-white/20"></div>
            <div className="text-center">
              <div className="text-2xl font-bold text-white">80% LTV</div>
              <div className="text-blue-200 text-sm">Max Financing</div>
            </div>
            <div className="w-px h-8 bg-white/20"></div>
            <div className="text-center">
