      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
            Get Church Loan Quote in{' '}
            <span className="text-blue-500">2 Minutes</span>
          </h2>
          <p className="text-xl text-slate-600 mb-8">
            AI-powered matching with specialized church lenders. Fast approvals for religious organization financing needs.
          </p>
          ...
          <div className="flex items-center justify-center space-x-4 mb-8">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-slate-600">Church Finance Specialists</span>
            </div>
          </div>
        </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {['Property Acquisition', 'Refinance Notes', 'Construction/Renovation', 'Debt Reduction'].map((type) => (
                      <button
                        key={type}
                        type="button"
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {['Church', 'Synagogue', 'Charter School', 'Non-Profit Org', 'Mixed-Use', 'Other Religious'].map((type) => (
                      <button
                        key={type}
                        type="button"
            ...
            {currentStep === 2 && (
              ...
              >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {['ASAP (< 30 days)', '1-3 months', '3-6 months', 'Planning stage (researching)'].map((timeline) => (
                      <button
                        key={timeline}
                        type="button"
