        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 mb-6 leading-relaxed">
              Your trusted partner for comprehensive financing solutions. From commercial real estate 
              to specialty lending, we provide fast approvals and competitive rates nationwide.
            </p>
            ...
            <div key={category}>
              ...
              <ul className="space-y-3">
                {links.map((link, index) => (
                  <li key={index}>
                    {link === 'About Us' ? (
                      <a href="/about-us" className="text-slate-400 hover:text-white transition-colors text-sm">
                        {link}
                      </a>
                    ) : link === 'Contact' ? (
                      <a href="/contact-us" className="text-slate-400 hover:text-white transition-colors text-sm">
                        Contact Us
                      </a>
                    ) : (
        ...
        <div className="border-t border-slate-800 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex items-center space-x-6 text-slate-400 text-sm">
              ...
              <a href="/consent-form" className="hover:text-white transition-colors">
                Consent Form
              </a>
            </div>
          </div>
